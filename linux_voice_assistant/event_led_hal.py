...
# Keep listening pulse alive for up to 15s after wakeword if user doesn't speak
...
class LedEvent(EventHandler):
    ...
    def voice_wakeword(self, data: dict):
        ...
        self.leds.run_action("flash_then_pulse", _RED, 2, _RED, 0.02)
    ...
    def voice_VOICE_ASSISTANT_STT_START(self, data: dict):
        ...
        self._cancel_watchdog()
        self.leds.run_action("pulse", _RED, 0.02)
