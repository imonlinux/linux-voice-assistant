...
# --- HAL-9000 Theme Constants ---
NUM_LEDS = 1
_OFF = (0, 0, 0)
_RED = (255, 0, 0)
_GREEN = (0, 255, 0) # Kept for initial startup blink
...
class LedController(EventHandler):
    ...
    def voice_vad_start(self, data: dict):
        pass # Continues pulsing red

    @subscribe
    def voice_stt_end(self, data: dict):
        self.run_action("fast_pulse", _RED)
    ...
    def voice_run_end(self, data: dict):
        self.run_action("color", _RED) # Idle state is solid red
