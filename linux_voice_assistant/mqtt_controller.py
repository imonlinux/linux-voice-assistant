...
class MqttController(EventHandler):
    ...
    def _on_connect(self, client, userdata, flags, rc):
        if rc == 0:
            ...
            # Subscribe to all command and state topics
    ...
    def _on_message(self, client, userdata, msg):
        ...
        if msg.topic == self.topics["mute"]["command"]:
            ...
            self.state.event_bus.publish("set_num_leds", {"num_leds": int(payload_str)})
    ...
    def _publish_discovery_configs(self):
        ...
        # Loop through states to create select and light entities
        for state_name in self.CONFIGURABLE_STATES:
